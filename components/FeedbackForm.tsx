...
export default function FeedbackForm({ projectId, projectName, projectDescription }: { projectId: string; projectName: string; projectDescription: string }) {
  ...
  const improveWithAI = async () => {
    ...
    try {
      ...
      const response = await fetch(url, {
        method: 'POST',
        body: JSON.stringify({ "feedback": feedback, "project description": projectDescription }),
      });
  ...
  const logFeedbackToMagicLoop = async (feedbackData: any) => {
  ...
  const submitFeedback = async (mentorId: string, mentorName: string, mentorEmail: string) => {
    try {
  ...
  const handleModalClose = (mentorInfo?: { id: string; name: string; email: string }) => {
        ...
        {aiSuggestions && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Consider these improvements for your feedback:</CardDescription>
            </CardHeader>
