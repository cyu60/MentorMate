      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm">Project URL (Optional)</FormLabel>
                <FormControl>
                  <Input type="url" placeholder="Github/Devpost" {...field} className="text-sm p-2" />
                </FormControl>
                <FormDescription className="text-xs">
          ...
          <FormField
            ...
            render={({ field: { onChange, name, onBlur, ref } }) => (
              <FormItem>
                <FormLabel className="text-sm">Project Background Image (Optional)</FormLabel>
                <FormControl>
